...
public class HeadsPanel extends JPanel {
	...
	public HeadsPanel(JFrame f, DbHandler d) {
		this.frame = f;
		this.db = d;
		this.partName = "head";
		this.columnNames = Variables.head_columnNames;
		this.selectedColumnSize = Variables.headColumnSize;
		this.initialize();
	}
	...
	public void initialize() {
		...
		btn_execute.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					DefaultTableModel tableModel = db.queryHeads(getCheckedBoxes(jcba), gender_types.toArray(),
